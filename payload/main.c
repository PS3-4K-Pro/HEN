...
//	map_path_slot("/dev_flash/vsh/module/xmb_plugin.sprx","/dev_flash/vsh/resource/AAA/xmb_plugin.sprx",0);// Shows IP Information on XMB™.
	...
	map_path_slot("/dev_hdd0/hen/hen_enable.xml","/dev_flash/hen/xml/hen_enabled.xml",5);// Switches the HEN Logo to Custom What's New.
	map_path_slot("/dev_flash/vsh/module/newstore_plugin.sprx","/dev_flash/vsh/resource/AAA/newstore_plugin.sprx",6);// Switches between PlayStation®Store versions.
