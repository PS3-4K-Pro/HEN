...
/* Custom What's New
	{whatsnew_offset, 0x68747470, &condition_true},
	{whatsnew_offset+4, 0x3A2F2F67, &condition_true},
	{whatsnew_offset+8, 0x69746875, &condition_true},
	{whatsnew_offset+0x0C, 0x622E636F, &condition_true},
	{whatsnew_offset+0x10, 0x6D2F4C75, &condition_true},
	{whatsnew_offset+0x14, 0x616E5465, &condition_true},
	{whatsnew_offset+0x18, 0x6C65732F, &condition_true},	
	{whatsnew_offset+0x1C, 0x57686174, &condition_true},
	{whatsnew_offset+0x20, 0x732D4E65, &condition_true},
	{whatsnew_offset+0x24, 0x772F7261, &condition_true},
	{whatsnew_offset+0x28, 0x772F6D61, &condition_true},
	{whatsnew_offset+0x2C, 0x696E2F77, &condition_true},
	{whatsnew_offset+0x30, 0x68617473, &condition_true},
	{whatsnew_offset+0x34, 0x5F6E6577, &condition_true},
	{whatsnew_offset+0x38, 0x2E786D6C, &condition_true},
	{whatsnew_offset+0x3C, 0, &condition_true},*/
...
PatchTableEntry patch_table[] =
{
	...
	{ LIBAUDIO_HASH, libaudio_patches }, // (bugged, it  causes an issue with Sony BT headset (Pulse) http://github.com/PS3Xploit/PS3HEN/issues/20
