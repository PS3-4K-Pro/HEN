...
#define BOOT_PLUGINS_KERNEL_FILE1	"/dev_usb000/external_boot_plugins_kernel.txt"
#define BOOT_PLUGINS_KERNEL_FILE2	"/dev_usb001/external_boot_plugins_kernel.txt"
